...
def paired : Text -> Text = \t.
  ...
  {if (t == "cytosine") {"guanine"}
  {"cytosine"}}}
end

def changeSide : Cmd Unit =
  tR; m2; tR; m4; tL; m4; tL; m4; tR; m2; tR
end
...
def pickup : Cmd Unit =
  wait 128;
  tL; m6; tL; m29; tL; m2; tL; m1; grab;
  tB; m1; tR; m2; tR; m29; tR; m6; tL
end

def button : Cmd Unit =
  m3; drill forward; tB; m3; tB
end

def clone : Text -> Cmd Unit = \thing.
  m5; place thing;
  tB; m5; tL; m4; tL; m1;
  wait 128;
  make "specimen slide";
...
def solution : Cmd Unit =
  m6; grab; tB; m6;
  tR; m9; grab; m6; grab; tB; m15; m11; tR;
  x8 (use "siphon" forward; m1);
  x64 (make "cytosine");
  tB; m13; tR; m14; grab; tB; m14; m8;
  tR; m7; clone "dahlia"; clone "daisy"; clone "clover"; clone "mushroom";
  return ()
end
